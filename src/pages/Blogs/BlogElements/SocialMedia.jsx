...
function SocialMedia() {
  return (
    <div className='blog lg:max-w-10/12 m-auto max-lg:px-2 flex max-lg:flex-col gap-5 lg:gap-7 max-lg:items-center mb-10 mt-2 lg:mt-15'>
            ...
            <img src={blog2} alt="" className='w-full lg:h-130 mb-5'/>
            ...
            <h1 className='text-xl lg:text-2xl font-bold mb-3'>Lotus Electronics – New Store Launch in Bhilai, Chhattisgarh</h1>
