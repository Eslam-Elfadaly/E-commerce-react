...
function Lifestyle() {
  return (
        <div className='blog lg:max-w-10/12 m-auto max-lg:px-2 flex max-lg:flex-col gap-5 lg:gap-7 max-lg:items-center mb-10 mt-2 lg:mt-15'>
            ...
            <img src={blog1} alt="" className='lg:w-full lg:h-130 mb-5'/>
            ...
            <h1 className='text-xl lg:text-2xl font-bold mb-3'>Office rental agency or direct? Which is best when renting an...</h1>
                ...
                <div className="latestBlog border-2 p-6">
                    ...
                    <ul className='flex flex-col gap-5 *:not-last:border-b-1 *:not-last:pb-5'>
                        ...
                        <li className='flex items-center gap-3 group hover:text-primary *:transition-all *:duration-300'>
                            <img src={blog2} alt="" className='group-hover:border-primary group-hover:border-1 lg:size-18 max-lg:size-16 rounded-full'/>
                            <p>Lotus Electronics – New Store Launch in Bhilai, Chhattisgarh</p>
                        </li>
                        </NavLink>

                        <NavLink to='/blog/CompanyNews'>
                        <li className='flex items-center gap-3 group hover:text-primary *:transition-all *:duration-300'>
                            <img src={blog3} alt="" className='group-hover:border-primary group-hover:border-1 size-18 max-lg:size-16 rounded-full'/>
                            <p>We Invite You to These Wonderful Wine Tasting Events</p>
                        </li>
                        </NavLink>
