...
const [loading, setLoading] = useState(false);
  ...
  return (
    ...
    <form onSubmit={handleLogin} className='w-[90%] m-auto flex flex-col gap-5 *:rounded-2xl'>
      ...
      <Button type="submit" disabled={!email || !password || password.length < 8 || loading} className={`p-5 text-lg text-white cursor-pointer`}>{loading? (<>Logging In <Spinner/></>):'Log In'}</Button>
